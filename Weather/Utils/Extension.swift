...
//  Weather
//
//  Created by P Deepanshu on 02/01/23.
//
...
extension View {
    func innerShadow<S: Shape, SS: ShapeStyle>(shape: S, color: SS, lineWidth: CGFloat = 1, offSetX: CGFloat = 0, offSetY: CGFloat = 0, blur: CGFloat = 4, blenMode: BlendMode = .normal, opacity: Double = 1) -> some
    View {
        return self
            .overlay {
